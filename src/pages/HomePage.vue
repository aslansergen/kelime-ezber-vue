<template>
    ...
    <div class="content" v-if="show">
        ...
        <div class="available">{{ activeWordNumber }}  </div>
        <div class="total"> {{ showingCategory.length -1 }} </div>
        <button @click="activeWordNumber > 0 && activeWordNumber--" class="prev"> d </button>
...
export default {
    ...
    methods:{
        ...
        setSmileCategory: function(){
            if(!this.showWord.btnSmile){
                console.log('setSmileCategory');
                this.changeWordCategory(this.ezberlenenKelime);
            }
        },
        setThinkCategory: function(){
            if(!this.showWord.btnThink){
                console.log('setThinkCategory');
                this.changeWordCategory(this.ezberlenecekKelime);
            }
        },
        setAngryCategory: function(){
            if(!this.showWord.btnAngry){
                console.log('setAngryCategory');
